...
<html lang="en">
  ...
  <body>
    ...
    <div id="myCarousel" class="carousel slide">
      <div class="carousel-inner">
        <div class="item active">
          ...
          <div class="container">
            <div class="carousel-caption">
              <h1>Sistem Pencarian SPBU Surabaya, Akurat, Terpercaya</h1>
        ...
        <div class="item">
          ...
          <div class="container">
            <div class="carousel-caption">
              <h1>Pencarian SPBU Berdasarkan Fasilitas</h1>
              
              <a class="btn btn-large btn-primary" href="#">Search</a>
            </div>
          </div>
        </div>
        <div class="item">
          ...
          <div class="container">
            <div class="carousel-caption">
              <h1>Pencarian SPBU Berdasarkan Lokasi</h1>
    ...
    <div class="container marketing">
      ...
      <div class="row"><!-- /.span4 --><!-- /.span4 --><!-- /.span4 -->
      </div><!-- /.row -->
