...
$query=mysql_query("select * from useradmin where username='$username' and password='$password'");	//melakukan pengampilan data dari database untuk di cocokkan
...
header("location:homeadmin.php");     // dan alihkan ke index.php
